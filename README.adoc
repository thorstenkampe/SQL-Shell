...
`SQL Shell` makes using your favorite SQL client even more convenient by bringing a standard interface to enter the necessary information to access your database so you don't have to remember command line options and syntax. Defaults are used for host name, port, and user to save you time.
