...
* legacy client support (https://docs.microsoft.com/en-us/sql/tools/sqlcmd-utility[`sqlcmd`], `mysql`, `SQLPlus`, `psql`, https://sqlite.org/cli.html[`sqlite3`])

== Requirements
* Windows: none
* Linux: Python3, modules `click`, `npyscreen`, and `sshtunnel`
* SQL shells: https://github.com/dbcli/mssql-cli[`mssql-cli`], https://www.mycli.net[`mycli`], https://www.oracle.com/database/technologies/appdev/sqlcl.html[`SQLcl`], https://www.pgcli.com[`pgcli`], https://litecli.com[`litecli`]
