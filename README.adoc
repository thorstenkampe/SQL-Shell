...
** (or legacy https://docs.microsoft.com/en-us/sql/tools/sqlcmd-utility[sqlcmd], https://dev.mysql.com/doc/refman/8.0/en/mysql.html[mysql], https://www.postgresql.org/docs/current/app-psql.html[psql], https://docs.oracle.com/en/database/oracle/oracle-database/21/sqpug/toc.htm[SQLPlus], https://sqlite.org/cli.html[sqlite3]
