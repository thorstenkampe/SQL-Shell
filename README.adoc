...
* a standard interface to enter information to access your database so you don't have to remember command line options and syntax
...
* legacy client (`sqlcmd`, `mysql`, `SQLPlus`, `psql`, `sqlite3`) support
